# Generated by Django 2.0.2 on 2019-04-08 13:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Act2Stu',
            fields=[
                ('a2s_num', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('u_gender', models.BooleanField(choices=[(0, '女'), (1, '男')], default=True, verbose_name='性别')),
                ('u_privilege', models.IntegerField(choices=[(0, '普通'), (1, '管理员')], verbose_name='权限')),
